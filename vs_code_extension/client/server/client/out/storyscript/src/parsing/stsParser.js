...
exports.stsParser = {
    parseModule: (tokens, moduleName) => {
        ...
        while (!exports.stsParser.isEndOfFile(state)) {
            ...
            if (subitemResult) {
                ...
                body = exports.stsParser.addItemToArray(body, subitem);
                continue;
            }
        ...
        const program = astFactory_1.astFactory.createProgram(body, start, end);
        const result = astFactory_1.astFactory.createModule(program, moduleName, start, end);
        return {
            errors,
            result
        };
    ...
    parseVariable: (state, targetIndent) => {
        ...
        if (exports.stsParser.getTokenOfType(state, [CodeTokenType_1.CodeTokenType.Endline])) {
            ...
            if (varValueLines) {
                varValue = astFactory_1.astFactory.createProgram(varValueLines, varValueStart, end);
            }
        }
